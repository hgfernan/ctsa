...
\begin{enumerate}
    ...
    \item {\bf Template creation}: This step is totally manual,
        ...
        \begin{enumerate}
            ...
            \item \label{itm:Python}
                One or more Python libraries is identified with
                exactly the same algoritm as in {\tt ctsa}.
                ...
                provided they have the same algorithm as {\tt ctsa};
